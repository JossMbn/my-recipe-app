...
private fun RecipeCreationPage(
    ...
    val headerTitle = remember(state.currentStep) {
        when (state.currentStep) {
            RecipeCreationSteps.FirstStep -> "Step 1/4"
            RecipeCreationSteps.SecondStep -> "Step 2/4"
            RecipeCreationSteps.ThirdStep -> "Step 3/4"
            RecipeCreationSteps.FourthStep -> "Step 4/4"
        }
    }
                ...
                Button(
                    ...
                    onClick = {
                        when (state.currentStep) {
                            ...
                            RecipeCreationSteps.FourthStep -> {
                                //onAction(RecipeCreationAction.OnValidateFourthStep)
                            }
                        }
                    },
                ) {
...
private fun RecipeCreationPageContent(
    ...
    when (state.currentStep) {
        ...
        RecipeCreationSteps.FourthStep -> RecipeCreationFourthStepPage(
            modifier = modifier,
            state = state,
            onAction = onAction,
            navigator = navigator
